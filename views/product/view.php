                ...
                <div class="product-details"><!--product-details-->
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
							<?php if ($product['sale']): ?>
								<?php echo Html::img('@web/images/home/sale.png', ['class' => 'newarrival', 'alt' => 'Распродажа']); ?>
							<?php else: ?>
								<?php echo Html::img('@web/images/home/new.png', ['class' => 'newarrival', 'alt' => 'Новинки']); ?>
							<?php endif; ?>
                            ...
                            <span>
                                ...
                                <a href="<?php echo \yii\helpers\Url::to(['cart/add', 'id' => $product->id]); ?>" data-id="<?php echo $product->id; ?>" type="button" class="btn add-to-cart btn-fefault cart">
                            ...
                            <p><b>Brand:</b> <?php echo $product->category[0]['name']; ?></p>
                            <a href="">
							...
							<?php $i = 0; foreach ($hits as $hit): ?>
                                ...
                                <div class="col-sm-4">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <?php echo Html::img('@web/images/products/'.$hit['img']); ?>
